...
HD_PWD='F:/FPGA_VIVADO/10DSP_TEST/DSP_TEST/DSP_TEST.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DSP_TEST_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DSP_TEST_wrapper.tcl
